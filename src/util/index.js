...
// At top of file:
import dotInverted from '../assets/dot-inverted.png';
import earthGlow from '../assets/earth-glow.jpg';
import mapInverted from '../assets/map_inverted.png';
import map from '../assets/map.png';
import star from '../assets/star.jpg';
import universe from '../assets/universe.jpg';

// Update cacheImages function:
function cacheImages() {
    const imageMap = {
        'dot-inverted.png': dotInverted,
        'earth-glow.jpg': earthGlow,
        'map_inverted.png': mapInverted,
        'map.png': map,
        'star.jpg': star,
        'universe.jpg': universe
    };

    return () => {
        const caches = Object.values(imageMap).map(src => {
